export declare const clerk: {
    ...
    authenticateRequest: ({ apiKey: runtimeApiKey, secretKey: runtimeSecretKey, audience: runtimeAudience, frontendApi: runtimeFrontendApi, proxyUrl: runtimeProxyUrl, publishableKey: runtimePublishableKey, jwtKey: runtimeJwtKey, isSatellite: runtimeIsSatellite, domain: runtimeDomain, searchParams, ...rest }: Omit<import("@clerk/clerk-sdk-node").AuthenticateRequestOptions, "apiUrl" | "apiVersion">) => Promise<import("@clerk/clerk-sdk-node").RequestState>;
    ...
    debugRequestState: (params: import("@clerk/clerk-sdk-node").RequestState) => {
        frontendApi: string;
        isSignedIn: boolean;
        proxyUrl: string | undefined;
    ...
    expressWithAuth: ReturnType<typeof import("@clerk/clerk-sdk-node").createClerkExpressWithAuth>;
    expressRequireAuth: ReturnType<typeof import("@clerk/clerk-sdk-node").createClerkExpressRequireAuth>;
    verifyToken: (token: string, verifyOpts?: Parameters<typeof import("@clerk/clerk-sdk-node").verifyToken>[1]) => ReturnType<typeof import("@clerk/clerk-sdk-node").verifyToken>;
} & {
    base: {
